...
Ниже приведена логическая схема компонентов пользовательского пула потоков и взаимодействия между ними.
...
| • прекращает работу, если (1) истёк `keepAliveTime` **и** текущий poolSize > `corePoolSize`          |                                            |                                                                                                                 |
